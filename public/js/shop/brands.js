...
function renderGrid() {
    ...
    brandsData.forEach((brand) => {
        ...
        card.className = "group relative bg-white rounded-[2rem] border border-gray-100 overflow-hidden shadow-sm hover:shadow-2xl hover:border-brand-orange/30 transition-all duration-300 hover:-translate-y-2 cursor-pointer h-56 flex flex-col";
        ...
        card.innerHTML = `
            ...
            <div class="relative z-10 mt-auto p-4 w-full bg-white/90 backdrop-blur-sm border-t border-gray-50 flex justify-between items-center translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                ...
                <i class="fa-solid fa-arrow-right text-[10px] text-brand-orange"></i>
            </div>
