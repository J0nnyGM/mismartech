...
function renderMatrix() {
    ...
    rows.forEach(row => {
        ...
        tr.innerHTML = `
            ...
            <td class="p-4"><input type="number" value="${prev.stock}" onchange="updateMatrixData('${row.key}', 'stock', this.value)" class="w-full bg-white border border-gray-200 rounded-lg p-2 text-xs font-bold text-brand-black outline-none focus:border-brand-orange"></td>`;
...
function unlockGlobalInputs() { 
    ...
    stockLabel.innerHTML = "Stock <span class='text-brand-orange'>(Manual)</span>"; 
