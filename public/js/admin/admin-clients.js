...
function renderClientRow(c) {
    ...
    else sourceTag = `<span class="bg-brand-orange/10 text-brand-orange px-3 py-1 rounded-full text-[9px] font-black uppercase border border-brand-orange/20">Web</span>`;
    ...
    row.innerHTML = `
        <td class="px-4 md:px-8 py-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center shrink-0 font-black text-brand-orange text-xs group-hover:bg-brand-orange group-hover:text-white transition uppercase">
...
if (btnOpen) {
    btnOpen.onclick = () => {
        ...
        document.getElementById('modal-title').innerHTML = `Registrar <span class="text-brand-orange">Cliente</span>`;
